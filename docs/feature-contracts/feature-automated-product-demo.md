...
| Object store | Supabase Storage REST (default prefix `demos/`) | `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, `SUPABASE_STORAGE_BUCKET` |
| Signed URL TTL (optional) | — | `DEMO_URL_TTL_SECONDS` or `REPORT_URL_TTL_SECONDS` |
